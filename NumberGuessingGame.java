...
public class NumberGuessingGame 
{
    ...
    public void menu(ArrayList<Integer> scoreBoard) 
    {
        ...
        System.out.println("1) Play the Number Guessing Game");
        System.out.println("2) Number Gussing Score Board");
        System.out.println("3) Exit");
        System.out.println("****************************************");
        try 
        {
            System.out.print("What action you like to do from the above actions? ");
